...
1. Generate a series of focused, probing questions that address:
...
2. Present your questions in a way that encourages deep, critical thinking and invites follow-up exploration.
...
5. Structure your output as a concise list of probing questions and prompts. You may use short paragraphs if necessary to provide context for your questions.
...
Your response:
- What specific criteria might we consider to define 'reasonable' grounds for withholding consent in this context?
- Are there any relevant statutory provisions or recent case law in our jurisdiction that could impact the interpretation of this clause?
- How might we balance the interests of both the landlord and tenant if a dispute arises over the reasonableness of withholding consent?
- Is the current language sufficiently clear to prevent future litigation, or are there terms that could benefit from further definition or clarification?
...
Your final output should consist only of your list of probing questions and prompts, without any direct answers, conclusions, or summaries. Focus on challenging the junior lawyer's thinking and encouraging deep exploration of the legal issue at hand.`;
